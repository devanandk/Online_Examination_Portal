...
<div id="navigation">
     ...
     out.println("<li id='active'><a href = 'AdminConsoleHome.jsp'>Administration Console</a></li>");
        ...
        Please click on the toggle switch to change the access privileges for the respective user.<br/><br/>
        ...
        <b style="color: red; padding-bottom: 10px" align="center">
            <% if(Usersession.getAttribute("UserPrivilageChangeException")!= null)
                out.print(Usersession.getAttribute("UserPrivilageChangeException")+"<br>"); %></b>
    ...
    Connection con2 = DriverManager.getConnection("jdbc:odbc:Online_Exam_Portal","","");
